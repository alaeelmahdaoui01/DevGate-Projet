<template>
  ...
  <script>
  import { editProject } from '@/Firebase/Firestore/editProject' // Adjust the path if necessary
  ...
  export default {
    ...
    watch: {
        selectedProject: {
            ...
            if (project) {
                ...
                this.imageBase64 = project.image || ""  // also load the image properly
            } else {
                this.resetForm()
            }
            }
    ...
    methods: {
      ...
      async updateProject() {
        ...
        try {
          const updatedData = {
            ...
            image: this.imageBase64 // Store the image as Base64
          }
  
          
  
          // Call the editProject function to update the project in Firestore
      ...
      handleFileChange(event) {
        ...
        reader.onload = () => {
          this.imageBase64 = reader.result // This is the Base64 string of the image
        }
